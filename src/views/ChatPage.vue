      ...
      <div class="header">
        <el-dropdown class="dropdown-menu">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item
                ><el-icon> <Edit /> </el-icon>修改名称</el-dropdown-item
              >
              <el-dropdown-item
                ><el-icon> <Share /> </el-icon>分享对话</el-dropdown-item
              >
              <el-dropdown-item
                ><el-icon> <Delete /> </el-icon>删除对话</el-dropdown-item
              >
            </el-dropdown-menu>
          </template>
        </el-dropdown>
...
.blulr-border {
  ...
  border-width: 4px;
  filter: blur(5px);
  box-shadow: -15px -15px 46px #fff, 15px 15px 46px #fff;
}
